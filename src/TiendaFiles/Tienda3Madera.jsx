    ...
    <>
      ...
      <div className="tienda" id="tienda3">
        ...
        <div className="menu">
          ...
          <h3>
            Pintura CADENCE de gesso con base de agua, especialmente formulada
            con partículas de diferentes tamaños y colores en su interior para
            crear una superficie antigua vintage rota.{" "}
          </h3>
