...
export const Tienda3PapersForYou = () => {
  ...
  return (
    <>
      ...
      <div className="tienda" id="tienda3">
        ...
        <div className="menu">
          <h1>Papeles para encuadernar - Paper For You 📘</h1>
        ...
        <div className="marcas2">
          <WavyLink
            direction="up"
            to="/tienda/cadence/papers-for-you/tela"
            color="#4593db"
          >
          ...
          <WavyLink
            direction="up"
            to="/tienda/cadence/papers-for-you/lino"
            color="#4593db"
          >
            <div className="cadence-card">
              <span className="badge-novedad">Novedades</span>
